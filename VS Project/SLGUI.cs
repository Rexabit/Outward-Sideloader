...
//            {
//                m_windowRect = new Rect(5, 5, 260, 200);
//            }
//            else
//            {
//                m_windowRect = GUI.Window(1273732, m_windowRect, DrawWindow, "Custom Item Spawner | SideLoader " + script._base.version.ToString("0.00"));
//            }
...
//            GUILayout.BeginArea(new Rect(4, 22, m_windowRect.width - 15, m_windowRect.height - 26), GUI.skin.box);
